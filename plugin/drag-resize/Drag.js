            ...
            case "mousemove":
                if (this.dragging !== undefined) {
                    ...
                    if( this.options.containment ) {
                        ...
                        var targetWidth = nono.DragDrop.getStyle(this.options.containment,"width")+nono.DragDrop.getStyle(this.options.containment,"paddingRight")+nono.DragDrop.getStyle(this.options.containment,"paddingLeft");
                        var targetHeight = nono.DragDrop.getStyle(this.options.containment,"height")+nono.DragDrop.getStyle(this.options.containment,"paddingTop")+nono.DragDrop.getStyle(this.options.containment,"paddingBottom");
                        //方向如果超出去的话那么就置0；
                        if( xValue < 0 ) {
                            xValue = 0;
                        };
                        ...
                        if( (xValue+objRect.width) > targetWidth ) {
                            xValue  = (targetRect.width-targetWidth) + "px";
                        };
                        if( (yValue+objRect.height) > targetHeight ) {
                            yValue = (targetRect.height-targetHeight) + "px";
                        };
                    };
